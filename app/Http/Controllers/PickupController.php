...
//     // Decode hidden inputs into arrays if needed
//     $request->merge([
...
//             'car_out_image' => isset($decoded) ? "damage_markings/damage_{$booking_id}.jpg" : null,
//             'markingRemarks' => $request->has('markingRemarks') ? $request->input('markingRemarks') : null,
//             'modified' => Carbon::now(),
//         ]
//     );
