...
class User extends Authenticatable implements LaratrustUser,MustVerifyEmail,JWTSubject
{
    ...
    protected $table = 'users'; // ✅ here
    public $timestamps = false; // ✅ here
    ...
    public static function CompanySetting($id = null,$workspace_id = null)
    {
        ...
        if(!empty($id))
        {
            ...
            $company_setting = [
                ...
                "proposal_title" => "",
                "proposal_notes" => "",
                "reservation_prefix" => "#RES0",
                "reservation_starting_number" => "1",
                "reservation_template" => "template1",
                "reservation_color" => "ffffff",
                "reservation_shipping_display" => "on",
                "reservation_title" => "",
                "reservation_notes" => "",
                "email_setting" => "smtp",
    ...
    {
        return $this->hasMany(BookingTrans::class, 'user_id');
    }
