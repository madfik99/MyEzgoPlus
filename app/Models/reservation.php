...
class reservation extends Model
{
    ...
    public static function reservationNumberFormat($number, $company_id = null,$workspace = null)
    {
        ...
        $data = !empty($company_settings['reservation_prefix']) ? $company_settings['reservation_prefix'] : '#INVO0';
    ...
    public function getTotalTax()
    {
        $totalTax = 0;
        foreach ($this->items as $product) {
            $taxes = reservation::totalTaxRate($product->tax);
