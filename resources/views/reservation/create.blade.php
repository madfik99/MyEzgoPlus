...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $("[name='reservation_type_radio']").trigger('change');
...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'reservation', 'class' => 'w-100', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row" id="customer-box">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ Form::select('customer_id', $customers, $customerId, ['class' => 'form-control', 'id' => 'customer', 'data-url' => route('reservation.customer'), 'required' => 'required', 'placeholder' => 'Please Select']) }}
    ...
    <script>
        ...
        $('#account_type').on('change', function() {
            ...
            if (optionsMap.hasOwnProperty(selectedOption)) {
                ...
                if (value !== null) {
                    $('[name="reservation_type_radio"]').append('<option value="' + value + '">' + optionsMap[selectedOption] + '</option>').trigger('change');
                }
            }
        });
    </script>
