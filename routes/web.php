...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::any('/debug-store1', function() {
        dd('store1 working!');
    });
    //Route::get('/reservation/nric/create', [ReservationController::class, 'createWithNric'])->name('reservation.nric.create');
    Route::post('/reservation/store1', [ReservationController::class, 'store1'])->name('reservation.store1');
    
    Route::get('/reservation/search', [ReservationController::class, 'search'])->name('reservation.search');
    Route::get('/reservation/counter-reservation-filter', [ReservationController::class, 'counterReservationFilter'])
    ->name('reservation.counter_reservation_filter');
    Route::post('/reservation/submit', [ReservationController::class, 'submitReservation'])->name('reservation.submit');
    Route::get('/reservation/summary', [ReservationController::class, 'showReservationSummary'])->name('reservation.summary');
    Route::post('/reservation/license-update/{nric}', [ReservationController::class, 'licenseUpdate'])->name('reservation.license_update');


    Route::get('reservation_list', [ReservationController::class, 'ReservationList'])->name('reservation.reservation_list');
    Route::get('/reservation/view/{booking_id}', [ReservationController::class, 'ReservationView'])->name('reservation.view');
    Route::post('/reservation/{booking}/update-vehicle', [ReservationController::class, 'updateVehicle'])->name('reservation.updateVehicle');

    Route::get('/reservation/form/{booking_id}', [ReservationController::class, 'ReservationForm'])->name('reservation.form');
    
    Route::get('/reservation/{booking_id}/change-vehicle', [ReservationController::class, 'changeVehicle'])->name('reservation.change_vehicle');

    Route::get('/agreement/{id}', [AgreementController::class, 'generate'])->name('agreement.generate');
    ...
    Route::group(['middleware' => 'PlanModuleCheck:Account-Taskly'], function () {
        ...
        //reservation
        Route::post('reservation-attechment/{id}', [ReservationController::class, 'reservationAttechment'])->name('reservation.file.upload');
        Route::delete('reservation-attechment/destroy/{id}', [ReservationController::class, 'reservationAttechmentDestroy'])->name('reservation.attachment.destroy');
        Route::post('reservation/customer', [ReservationController::class, 'customer'])->name('reservation.customer');
        Route::post('reservation/product', [ReservationController::class, 'product'])->name('reservation.product');
        Route::get('reservation/{id}/convert', [ReservationController::class, 'convert'])->name('reservation.convert');
        Route::get('reservation/{id}/duplicate', [ReservationController::class, 'duplicate'])->name('reservation.duplicate');
        Route::get('reservation/items', [ReservationController::class, 'items'])->name('reservation.items');
        Route::post('reservation/product/destroy', [ReservationController::class, 'productDestroy'])->name('reservation.product.destroy');
        
        // ✅ Put custom route first to avoid conflict
        Route::get('/reservation/nric/create', [ReservationController::class, 'createWithNric'])->name('reservation.nric.create');

        // Resource routes (this comes after)
        Route::resource('reservation', ReservationController::class)->except(['create']);

        Route::get('reservation/grid/view', [ReservationController::class, 'Grid'])->name('reservation.grid.view');
        Route::get('reservation/create/{cid}', [ReservationController::class, 'create'])->name('reservation.create');
        Route::get('reservation/{id}/status/change', [ReservationController::class, 'statusChange'])->name('reservation.status.change');
        Route::get('reservation/{id}/resent', [ReservationController::class, 'resent'])->name('reservation.resent');
        Route::post('reservation/section/type', [ReservationController::class, 'reservationSectionGet'])->name('reservation.section.type');
        Route::get('reservation/{id}/sent', [ReservationController::class, 'sent'])->name('reservation.sent');
        Route::get('reservation/stats/view', [ReservationController::class, 'reservationQuickStats'])->name('reservation.stats.view');
    ...
    // reservation template setting save
    Route::get('/reservation/preview/{template}/{color}', [ReservationController::class, 'previewInvoice'])->name('reservation.preview');
    Route::post('/reservation/template/setting', [ReservationController::class, 'saveTemplateSettings'])->name('reservation.template.setting');
...
// reservation
Route::get('/reservation/pay/{reservation}', [ReservationController::class, 'payreservation'])->name('pay.reservationpay');
Route::get('reservation/pdf/{id}', [ReservationController::class, 'reservation'])->name('reservation.pdf');
